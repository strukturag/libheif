...
#ifndef LIBHEIF_UNC_DECODER_BLOCK_COMPONENT_INTERLEAVE_H
#define LIBHEIF_UNC_DECODER_BLOCK_COMPONENT_INTERLEAVE_H
...
class unc_decoder_block_component_interleave : public unc_decoder
{
public:
...
class unc_decoder_factory_block_component_interleave : public unc_decoder_factory
{
private:
