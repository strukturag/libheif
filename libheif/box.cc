...
{
  assert((int32_t) num <= std::numeric_limits<int32_t>::max());
  assert((int32_t) den <= std::numeric_limits<int32_t>::max());
...
Error Box_clap::parse(BitstreamRange& range)
{
  ...
  if ((int32_t) clean_aperture_width_num > std::numeric_limits<int32_t>::max() ||
      (int32_t) clean_aperture_width_den > std::numeric_limits<int32_t>::max() ||
      (int32_t) clean_aperture_height_num > std::numeric_limits<int32_t>::max() ||
      (int32_t) clean_aperture_height_den > std::numeric_limits<int32_t>::max() ||
      (int32_t) horizontal_offset_num > std::numeric_limits<int32_t>::max() ||
      (int32_t) horizontal_offset_den > std::numeric_limits<int32_t>::max() ||
      (int32_t) vertical_offset_num > std::numeric_limits<int32_t>::max() ||
      (int32_t) vertical_offset_den > std::numeric_limits<int32_t>::max()) {
    return Error(heif_error_Invalid_input,
