...
#ifndef LIBHEIF_COLORCONVERSION_TONEMAPPING_ZIMG_H
#define LIBHEIF_COLORCONVERSION_TONEMAPPING_ZIMG_H
...
class Op_zimg : public ColorConversionOperation
{
public:
...
#endif //LIBHEIF_COLORCONVERSION_TONEMAPPING_ZIMG_H
