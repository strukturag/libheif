                                           ...
                                           const heif_color_conversion_options& options) const
{
  ...
  if (auto err = outimg->add_plane2(heif_channel_Y, width, height, bpp) ||
                 outimg->add_plane2(heif_channel_Cb, cwidth, cheight, bpp) ||
                 outimg->add_plane2(heif_channel_Cr, cwidth, cheight, bpp)) {
    return err;
  }
                                         ...
                                         const heif_color_conversion_options& options) const
{
  ...
  if (auto err = outimg->add_plane2(heif_channel_Y, width, height, 8) ||
                 outimg->add_plane2(heif_channel_Cb, chroma_width, chroma_height, 8) ||
                 outimg->add_plane2(heif_channel_Cr, chroma_width, chroma_height, 8)) {
    return err;
  }
                                                ...
                                                const heif_color_conversion_options& options) const
{
  ...
  if (auto err = outimg->add_plane2(heif_channel_Y, width, height, 8) ||
                 outimg->add_plane2(heif_channel_Cb, width, height, 8) ||
                 outimg->add_plane2(heif_channel_Cr, width, height, 8)) {
    return err;
  }
