...
#ifndef LIBHEIF_COLORCONVERSION_TONEMAPPING_HDR_SDR_H
#define LIBHEIF_COLORCONVERSION_TONEMAPPING_HDR_SDR_H
...
#endif //LIBHEIF_COLORCONVERSION_TONEMAPPING_HDR_SDR_H
