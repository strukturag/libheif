...
LIBHEIF_API
const heif_complex32* heif_image_get_channel_complex32_readonly(const struct heif_image*,
                                                                enum heif_channel channel,
                                                                int* out_stride);

LIBHEIF_API
const heif_complex64* heif_image_get_channel_complex64_readonly(const struct heif_image*,
                                                                enum heif_channel channel,
                                                                int* out_stride);
