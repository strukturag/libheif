...
*/
  ...
  snprintf(plugin_name, MAX_PLUGIN_NAME_LENGTH, "VVdeC");
...
//  memset(&decoder->data, 0, sizeof(VVdeCData));
...
{
  MAYBE_UNUSED auto* decoder = (struct vvdec_decoder*) decoder_raw;
